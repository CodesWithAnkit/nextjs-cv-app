      ...
      <div className="fj-hero-wrapper row">
        <div className="hero-left col-md-6">
          <h1 className="white hero-title">
            Hey I'm Ankit. Experienced full stack developer
          </h1>
        ...
        <div className="list-group">
          ...
          >
            ...
            <div className="avatar-container my-2">
              ...
              ></img>
              <span className="avatar-title">Ankit Kumar Sharma</span>
            </div>
          </a>
          <a
            href="#"
                      ...
                      <div className="topic-header">
                        <div className="topic-meta">
                          <div className="name-container">
                            <span className="name">Ankit Kumar Sharma</span>
                          </div>
